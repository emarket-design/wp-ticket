...
function wp_ticket_com_show_optin() {
	...
	if (!get_option('wp_ticket_com_tracking_optin')) {
		...
		echo $tr_msg . '</p>';
		echo '<p>' . __('Please confirm your email address below to start receiving emails from us.', 'wp-ticket-com') . '</p>';
		$current_user = wp_get_current_user();
		...
		echo '<li class="emd-permission"><i class="dashicons dashicons-email-alt"></i><div><span>' . __('Newsletter', 'wp-ticket-com') . '</span><p>' . __('Updates, announcements, marketing, no spam', 'wp-ticket-com') . ', <a href="https://emdplugins.smartlamb.com/subscription-preferences/" target="_blank">unsubscribe anytime</a></p></div></li>';
