...
function emd_form_builder_lite_get_page(){
	...
	if(!empty($_GET['page_id']) && !empty($_GET['app']) && !empty($_GET['entity'])){
		...
		if($_GET['page_id'] == 1){
			...
			$psetting .= '<div class="emd-form-builder-field-settings-wrap emd-field-page' . $page_id . '" style="display:none;">
				<div class="emd-form-builder-field-setting step-title">
				<label for="emd-field-step-title">' . __('Step Title','emd-plugins') . '</label>
				<input type="text" name="fields[step_title_' . $page_id . '][value]" id="emd-fbform-' . $page_id . '" class="emd-form-builder-field-step-title">
				</div>
				<div class="emd-form-builder-field-setting step-desc">
				<label for="emd-field-step-desc">' . __('Step Description','emd-plugins') . '</label>
				<textarea name="fields[step_desc_' . $page_id . '][value]" id="emd-fbform-' . $page_id . '" class="emd-form-builder-field-step-desc" rows=3></textarea>
				</div></div>';
		}
